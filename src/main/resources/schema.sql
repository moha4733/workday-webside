...
CREATE TABLE IF NOT EXISTS projects (
  ...
  CONSTRAINT fk_projects_worktype FOREIGN KEY (work_type_id) REFERENCES work_types(id)
);
...
CREATE TABLE IF NOT EXISTS material_orders (
  ...
  description VARCHAR(1024),
  CONSTRAINT fk_material_orders_user FOREIGN KEY (user_id) REFERENCES users(id)
);
...
CREATE TABLE IF NOT EXISTS day_plans (
  ...
  project_id BIGINT,
  date DATE NOT NULL,
  CONSTRAINT fk_day_plans_user FOREIGN KEY (user_id) REFERENCES users(id),
  CONSTRAINT fk_day_plans_project FOREIGN KEY (project_id) REFERENCES projects(id)
);
